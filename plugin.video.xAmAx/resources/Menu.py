...
class menu():
    ...
    def __init__(self):
        ...
        self.Param = {"Chemin":""}
        self.nomPlugin = 'plugin.video.xAmAx'
        ...
        self._MenuList={"Chaines TV et bouquet":("TV","VisuLiveStream",True),
            ...
            if params['action'] == 'Menu':
                if params['Option'] =="TV":#----------------------------------------------------------------------------------------
                    ...
                    if params['ElemMenu']=='MajTV':
                        ...
                        VLspopt = self.adn.getSetting(id="LSPOpt")
                        print "Version Recherche TV: "+VLspopt+" Version sur internet: "+VRech
                        if VLspopt!=str(VRech):
                            ...
                            dest = os.path.join(self.AdressePlugin, "resources", "LSPOpt.py")
                            fichier = open(dest, "w")
                            fichier.write(LSPOpt)
                            fichier.close()
                            self.adn.setSetting(id="LSPOpt", value=str(VRech))"""
